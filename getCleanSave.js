// The get getCleanSAveAllNPSJobs function gets all jobs in the NPS -- open to the public and "status" or other hiring authority jobs.
...
export async function getCleanSaveAllNpsJobs() {
    let allJobs = [];
    let currentPage = 1;
